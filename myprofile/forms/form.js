...
document.addEventListener('DOMContentLoaded', function() {
	document.getElementsByName("submit")[0].onclick = function(){
			...
			let hasEmptyValueIncludes = Object.values(requiredInputFields).includes("");
			if (hasEmptyValueIncludes)
			{

				alert("Вы заполнили не все обязательные поля!")

			} else {
				const data = Object.assign(requiredInputFields, optionalFields)
